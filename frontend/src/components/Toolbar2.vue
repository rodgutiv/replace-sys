...
div(id="barra")
    ...
    v-toolbar(color="black darken-1" dark app id="tol")
      ...
      v-toolbar-title(slot="extension")
        v-btn(flat)
            v-img(id="logo" to="" src="http://vps-nodolab.com:3000/imagenes/Logo.png")
      v-spacer
      ...
      v-toolbar-items(slot="extension" id="to")
        v-btn(flat )
          v-img(src="http://vps-nodolab.com:3000/imagenes/carrito_compra.png")
      v-toolbar-items(id="min")
        v-btn(id="boton")
            v-img(id="ima" src="http://vps-nodolab.com:3000/imagenes/twiter.png")
        v-btn(id="boton")
            v-img(id="ima" src="http://vps-nodolab.com:3000/imagenes/facebook.png")
        v-btn(id="boton")
            v-img(id="ima" src="http://vps-nodolab.com:3000/imagenes/instagram.png")
        v-btn(id="boton")
            v-img(id="ima" src="http://vps-nodolab.com:3000/imagenes/correo.png")
