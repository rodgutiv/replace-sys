        ...
        v-flex(xs6 sm6 id="bloques")
          v-layout(row id="busquedas" style="height:100%;")
            v-flex(xs2 style="padding-top: 130px; margin-left: 25%;")
              a(v-on:click="Submit()")
                v-img(src="http://vps-nodolab.com:3000/public/imagenes/lupita busqueda.png" width="50px")
              ...
              v-layout(row  )
                v-flex(xs4 style="padding-top: 30px;")
                  a(v-on:click="Submit2")
                    v-img(src="http://vps-nodolab.com:3000/public/imagenes/lupita busqueda.png" max-width="40px")
    ...
    v-container(grid-list-md r )
      ...
      v-layout(id="carrusel" center )
        v-flex(xs3 style="padding:0" )
            ...
            div
              v-img(v-on:click="width=500;height=400;" src="http://vps-nodolab.com:3000/public/imagenes/freno1.png")
        ...
        v-flex(xs3 style="padding:0")
            ...
            div
              v-img(src="http://vps-nodolab.com:3000/public/imagenes/freno2.png")
            h3(class="white--text" style="padding-left:30%;") FRENOS
    ...
    v-container(grid-list-md r id="mas_vendidos")
      ...
      v-layout(id="carrusel" center)
        v-flex(xs3 style="padding:0")
            ...
            div
              v-img(src="http://vps-nodolab.com:3000/public/imagenes/freno1.png")
            h3(class="white--text" style="padding-left:30%;") FRENOS
        v-flex(xs3 style="padding:0")
    ...
    v-container
      v-layout(class="white--text" text-xs-center row  wrap style="width: 100%;")
                v-flex(flex xs4)
                    ...
                    v-layout(row  wrap)
                        v-flex(xs4)
                            v-img(src="http://vps-nodolab.com:3000/public/imagenes/atención_al_cliente.png" width="30%"  style="margin-left:80%;")
                        v-flex(xs8)
                            v-layout(row  wrap)
                                v-flex(xs12)
                                    span Contactanos
                    ...
                    v-layout(row  wrap)
                        v-flex(xs4)
                            v-img(src="http://vps-nodolab.com:3000/public/imagenes/ubicación.png" width="30%"    style="margin-left:80%;")
                        v-flex(xs8)
                            v-layout(row  wrap)
                                v-flex(xs12)
